  ...
  const PROTOCOLOS = {
    ...
    'aspirador_smaf_sxt5a': {
      ...
      pruebasFuncionales: [
        ...
        { id: 'aspf5', prueba: 'Caudal de aspiración — Conectar manguera estándar 6 mm y medir caudal libre con rotámetro o cronometrado de volumen', valorEsperado: '≥ 20 L/min de caudal libre (especificación nominal SXT-5A)', resultado: ['Pasa', 'Falla'] },
        ...
        { id: 'aspf8', prueba: 'Flotador de seguridad — Simular nivel máximo bloqueando el flotador manualmente; verificar corte de paso al motor', valorEsperado: 'Vacío cae inmediatamente al activar el flotador; motor no sufre daño', resultado: ['Pasa', 'Falla'] },
        { id: 'aspf9', prueba: 'Temperatura de operación continua — Operar el equipo a vacío máximo durante 10 minutos continuos', valorEsperado: 'Sin sobrecalentamiento de carcasa (< 60 °C al tacto); sin olor a quemado', resultado: ['Pasa', 'Falla'] },
        { id: 'aspf10', prueba: 'Nivel sonoro — Medir nivel de ruido en operación normal a 1 metro del equipo', valorEsperado: '≤ 65 dB(A) en condiciones normales de operación', resultado: ['Pasa', 'Falla'] },
      ],
      estadoFinal: ['Apto para uso', 'Apto con observaciones', 'No apto / retirar de servicio'],
      accionesRealizadas: [
